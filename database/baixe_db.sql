...
--
-- Đang đổ dữ liệu cho bảng `bienso`
--

INSERT INTO `bienso` (`id`, `so_bien`, `chu_xe`, `sdt`, `email_chu_xe`, `ngay_dang_ky`, `trang_thai`, `tong_lan_vao`, `tong_lan_ra`, `lan_vao_gan_nhat`, `lan_ra_gan_nhat`, `ghi_chu`, `ngay_cap_nhat`) VALUES
(1, '84L1-751.64', 'Nguyễn Minh Khởi', '0866085947', NULL, '2026-02-03', 1, 0, 0, NULL, NULL, NULL, '2026-02-03 17:28:44'),
(2, '59E1 - 21500', '', NULL, NULL, '2026-02-03', 1, 0, 0, NULL, NULL, NULL, '2026-02-03 19:04:15'),
(3, '54U5 - 7001', 'Nguyen Van B', '123456789', NULL, '2026-02-03', 1, 0, 0, NULL, NULL, NULL, '2026-02-03 18:05:00');
...
INSERT INTO `lichsu` (`id`, `so_bien`, `thoi_gian`, `loai_su_kien`, `duong_dan_anh`, `duong_dan_anh_goc`, `ghi_chu`, `operator_id`, `ngay_cap_nhat`) VALUES
(1, '59E1 - 21500', '2026-02-03 17:28:06', 'VAO', 'uploads\\59E1_-_2150_VAO_20260203_172806.jpg', NULL, NULL, NULL, '2026-02-03 17:28:06'),
(4, '59E1 - 21500', '2026-02-03 17:54:50', 'VAO', 'uploads\\59E1_-_21500_VAO_20260203_175450.jpg', NULL, NULL, NULL, '2026-02-03 17:54:50'),
(5, '54U5 - 7001', '2026-02-03 18:04:41', 'VAO', 'uploads\\54U5_-_1001_VAO_20260203_180441.jpg', NULL, NULL, NULL, '2026-02-03 18:04:41'),
(10, '59E1 - 21500', '2026-02-03 19:02:34', 'VAO', 'uploads\\59E1_-_21500_VAO_20260203_190234.jpg', NULL, NULL, NULL, '2026-02-03 19:02:34'),
(11, '59E1 - 21500', '2026-02-03 19:04:15', 'RA', 'uploads\\59E1_-_21500_RA_20260203_190415.jpg', NULL, NULL, NULL, '2026-02-03 19:04:15');
...
INSERT INTO `users` (`id`, `username`, `password`, `ho_ten`, `email`, `vai_tro`, `trang_thai`, `ngay_tao`, `ngay_cap_nhat`) VALUES
(1, 'admin', 'admin123', 'Admin', 'admin@baixe.local', 'admin', 1, '2026-02-03 10:08:30', '2026-02-03 10:08:30'),
(2, 'operator1', 'op123', 'Nhân viên 1', 'op1@baixe.local', 'operator', 1, '2026-02-03 10:08:30', '2026-02-03 10:08:30'),
(3, 'viewer1', 'view123', 'Xem dữ liệu', 'view1@baixe.local', 'viewer', 1, '2026-02-03 10:08:30', '2026-02-03 10:08:30');
...
--
-- AUTO_INCREMENT cho bảng `danh_sach_den`
--
ALTER TABLE `danh_sach_den`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT cho bảng `vi_pham`
--
ALTER TABLE `vi_pham`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `chi_tiet_xe`
  ADD CONSTRAINT `fk_chi_tiet_bienso` FOREIGN KEY (`so_bien`) REFERENCES `bienso` (`so_bien`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `danh_sach_den`
--
ALTER TABLE `danh_sach_den`
  ADD CONSTRAINT `fk_danh_sach_den_bienso` FOREIGN KEY (`so_bien`) REFERENCES `bienso` (`so_bien`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `lichsu`
--
ALTER TABLE `lichsu`
  ADD CONSTRAINT `fk_lichsu_bienso` FOREIGN KEY (`so_bien`) REFERENCES `bienso` (`so_bien`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_lichsu_operator` FOREIGN KEY (`operator_id`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `thanh_toan`
--
ALTER TABLE `thanh_toan`
  ADD CONSTRAINT `fk_thanh_toan_bienso` FOREIGN KEY (`so_bien`) REFERENCES `bienso` (`so_bien`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `vi_pham`
--
ALTER TABLE `vi_pham`
  ADD CONSTRAINT `fk_vi_pham_bienso` FOREIGN KEY (`so_bien`) REFERENCES `bienso` (`so_bien`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
